  ...
  50% {
    ...
    * {    
    ...
    header {    
      ...
      align-items: center;    
      padding:20px 30px;    
      background: linear-gradient(200deg, #000000, #1f1f1f);    
      box-shadow: 30 20 100px #00ffff;    
    }    
    .logo-section {    
      display: flex;    
      align-items:center;    
...
<div id="contact" style="...">
  <!-- contact content -->
</div>  <div style="background:#1f1f1f; border-radius:5px; padding:25px; box-shadow: 0 0 10px #00ffff; text-align:center; color: #fff;">  
